...
import {
  Stack, Card, Group, Title, Text, Badge, Button,
  TextInput, Textarea, Switch, Loader, Center
} from '@mantine/core';
import {
  useHRVacancies, useCreateVacancy, useUpdateVacancy, useDeleteVacancy,
  type HRVacancy, type HRVacancyCreate,
} from '../hrApi';
...
function VacancyForm({ initial, onSubmit, onCancel, isLoading }: VacancyFormProps) {
  ...
  return (
    <Stack mt="md">
      <Group justify="space-between">
        <Text fw={600} size="lg">Мои вакансии</Text>
      ...
      {!vacancies?.length && !creating && (
        <Text size="sm" c="dimmed">Вакансий пока нет. Создайте первую!</Text>
      )}
